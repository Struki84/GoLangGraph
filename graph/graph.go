...
type Edge struct {
	...
	To func(ctx context.Context, state []llms.MessageContent) string // (ctx context.Context, state []llms.MessageContent) (string, error]) string
}
...
func (g *MessageGraph) AddEdge(from, to string) {
	g.edges = append(g.edges, Edge{
		From: from,
		To: func(_ context.Context, state []llms.MessageContent) string {
